          ...
          {t.stats.items.map((item, i) => {
            ...
            return (
              <Reveal key={item.label} delay={i * 120}>
                <div className="flex h-full flex-col items-center rounded-3xl border border-ink-line bg-ink-raised px-6 py-10">
                  <span
                  ...
                  <p className="mt-3 text-[15px] text-cream-muted md:text-[16px]">{item.label}</p>
                </div>
              </Reveal>
            );
          })}
